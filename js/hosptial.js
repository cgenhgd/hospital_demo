...
//    给出所有的筛选条件 
    ...
    $('.filter')
        ...
        $('.datalist').delegate(".button","click",function(){
            
                var name=$(this).parents('.item').attr("hname");
                name=encodeURI(name);
                window.location.href="hospital_detail.html?name="+name;
